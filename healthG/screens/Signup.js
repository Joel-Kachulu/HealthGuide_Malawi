...
const Signup = ({ navigation }) => {
  ...
  const authHandler = async () => {
    try {
      ...
      const response = await fetch('http://192.168.42.104:3000/signup', {
        method: 'POST',
        headers: {
      ...
      setIsLoading(false);
      Alert.alert("Signup successful", "Successfully signed");
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.background }}>
      ...
      >
        ...
        <Text style={{ ...FONTS.body2, color: COLORS.gray }}>
          Sign up now for free and start monitoring your health, and explore HealthGuide.
        </Text>
